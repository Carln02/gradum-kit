...
export function setupHierarchyFunctions() {
    ...
    Object.defineProperty(GradumSelector.prototype, "childHandler", {
        set: function (value?: Node) {
            if (value instanceof GradumSelector) value = value.element;
    ...
    GradumSelector.prototype.bringToFront = function _bringToFront(this: GradumSelector): GradumSelector {
        const parent = this.element?.parentNode;
    ...
    GradumSelector.prototype.sendToBack = function _sendToBack(this: GradumSelector): GradumSelector {
        const parent = this.element?.parentNode;
        if (!parent) return this;
     ...
     */
    GradumSelector.prototype.remove = function _remove(this: GradumSelector): GradumSelector {
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.addChild = function _addChild(
        this: GradumSelector, children?: Node | Node[], index?: number,
        referenceList: Node[] | NodeListOf<Node> = this.childrenArray): GradumSelector {
        ...
        if (index != undefined) this.addChildBefore(children, referenceList[index]);
            ...
            children.forEach((child: Element) => {
                if (!child) return;
                if (child instanceof GradumSelector) child = child.element;
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.remChild = function _remChild(this: GradumSelector, children?: Node | Node[]): GradumSelector {
        if (!this.element || !children) return this;
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.addChildBefore = function _addChildBefore
    (this: GradumSelector, children?: Node | Node[], sibling?: Node): GradumSelector {
        if (!this.element || !children) return this;
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.removeChildAt = function _removeChildAt(
        this: GradumSelector, index?: number, count: number = 1,
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.removeAllChildren = function _removeAllChildren(
        this: GradumSelector, referenceList: Node[] | NodeListOf<Node> = this.childrenArray): GradumSelector {
     ...
     */
    GradumSelector.prototype.childAt = function _childAt(
        this: GradumSelector, index?: number,
        referenceList: Node[] | NodeListOf<Node> = this.childrenArray
    ): Node {
     ...
     */
    GradumSelector.prototype.indexOfChild = function _indexOfChild(
        this: GradumSelector, child?: Node,
        referenceList: Node[] | NodeListOf<Node> = this.childrenArray
    ): number {
     ...
     */
    GradumSelector.prototype.hasChild = function _hasChild(this: GradumSelector, children?: Node | Node[]): boolean {
     ...
     */
    GradumSelector.prototype.closest = function _closest(
        this: GradumSelector,
     ...
     */
    GradumSelector.prototype.findInParents = function _findInParents(this: GradumSelector, parents?: Node | Node[]): boolean {
     ...
     */
    GradumSelector.prototype.findInSubTree = function _findInSubTree(this: GradumSelector, children?: Node | Node[]): boolean {
     ...
     * @returns {boolean} True if the children belong to the node, false otherwise.
     */
    GradumSelector.prototype.indexInParent = function _indexInParent(
        this: GradumSelector, referenceList: Node[] = this.siblings as Node[]): number {
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.addToParent = function _addToParent(
        this: GradumSelector,
        parent?: Node,
        index?: number,
