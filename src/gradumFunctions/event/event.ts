...
export function setupEventFunctions() {
    ...
    Object.defineProperty(GradumSelector.prototype, "bypassManagerOn", {
        ...
        set: function (value: (e: Event) => boolean | GradumEventManagerStateProperties) {
     ...
     */
    GradumSelector.prototype.onTool = function _onTool<Type extends Node>(
        this: Gradum<Type>,
        type: string,
        toolName: string,
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.on = function _on<Type extends Node>(
        this: Gradum<Type>,
        type: string,
        listener: ListenerCallback<Gradum<Type>>,
        options?: ListenerOptions,
        manager: GradumEventManager = GradumEventManager.instance
    ): Gradum<Type> {
    ...
    GradumSelector.prototype.executeAction = function _executeAction(
        ...
        const checkedConstrainersFor: Set<Node> = new Set();
        ...
        main();
        if (options.solveConstrainers) checkedConstrainersFor.forEach(entry =>
            gradum(this).solveConstrainersForEvent({
                event,
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.removeListener = function _removeListener<Type extends Node>(
        this: Gradum<Type>,
        type: string,
        listener: ListenerCallback,
        manager: GradumEventManager = GradumEventManager.instance
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.removeToolListener = function _removeToolListener<Type extends Node>(
        this: Gradum<Type>,
        type: string,
        toolName: string,
        listener: ListenerCallback,
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.removeListenersByType = function _removeListenersByType(
        this: Gradum,
        type: string,
        toolName?: string,
        manager: GradumEventManager = GradumEventManager.instance
     ...
     * @returns {this} Itself, allowing for method chaining.
     */
    GradumSelector.prototype.removeAllListeners = function _removeListeners(
        this: GradumSelector,
        manager: GradumEventManager = GradumEventManager.instance
    ): GradumSelector {
     ...
     */
    GradumSelector.prototype.preventDefault = function _preventDefault(this: Gradum, options?: PreventDefaultOptions): GradumSelector {
        if (!options) options = {};
