...
import {GradumMarkingMenuProperties} from "./markingMenu.types";
...
> extends GradumElement<ViewType, DataType, ModelType> {
     public declare readonly properties: GradumMarkingMenuProperties;
    ...
    // public constructor(properties: GradumMarkingMenuProperties<ValueType, SecondaryValueType, EntryType, ViewType,
    //     DataType, ModelType> = {}) {
    //     super(properties);
    //     super.show(false);
    //
    ...
    // }
    //
    // public addEntry(entry: ValueType | GradumSelectEntryProperties<ValueType, SecondaryValueType> | EntryType
