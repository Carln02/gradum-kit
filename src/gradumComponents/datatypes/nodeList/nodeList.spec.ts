...
function collectChanges(list: GradumNodeList<any>) {
...
describe("GradumNodeList", () => {
    let parent: HTMLElement;

    beforeEach(() => {
        parent = document.createElement("div");
        gradum(document.body).addChild(parent);
    });

    afterEach(() => gradum(document.body).removeChild(parent));

    describe("constructor", () => {
        it("initializes empty with no arguments", () => {
            const list = new GradumNodeList();
        ...
        it("initializes with a single entry", () => {
            const a = makeEntry("a");
            const list = new GradumNodeList(a);
        ...
        it("initializes with an array", () => {
            const a = makeEntry("a");
            const b = makeEntry("b");
            const list = new GradumNodeList([a, b]);
        ...
        it("initializes with a Set", () => {
            const a = makeEntry("a");
            const b = makeEntry("b");
            const list = new GradumNodeList(new Set([a, b]));
            expect(list.size).toBe(2);
        });
        ...
        it("initializes with multiple values via spread", () => {
            const a = makeEntry("a");
            const b = makeEntry("b");
            const list = new GradumNodeList(a as any, b as any);
            expect(list.size).toBe(2);
        });
    });
    ...
    describe("sub-list (GradumNodeList) slots", () => {
    ...
    describe("adding an HTMLCollection slot", () => {
        it("iterates the collection's current entries", () => {
            ...
            const list = new GradumNodeList<Element>();
            list.add(collection);
